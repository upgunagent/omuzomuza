...
export default function ConsultantEditCandidatePage({ params }: { params: Promise<{ id: string }> }) {
    const { id } = use(params);
    ...
    async function checkAuthAndFetchName() {
        ...
        // Check if consultant or admin (Optional: Add stricter role check here)
    ...
    return (
        <div className="container mx-auto py-6 space-y-6">
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-2xl font-bold">Aday Düzenle</h1>
