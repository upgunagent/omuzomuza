...
export default function AdminEditCandidatePage() {
    ...
    async function fetchData() {
        ...
        if (error) {
            ...
            router.push(`/admin/positions/${positionId}/report`);
            return;
        }
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-6 pb-12">
            <div className="flex items-center gap-4">
                <Link href={`/admin/positions/${positionId}/report`}>
                    <Button variant="outline" size="icon"><ArrowLeft className="w-4 h-4" /></Button>
                </Link>
                <div>
                    <h1 className="text-2xl font-bold text-slate-800">Aday Düzenle (Admin)</h1>
            ...
            <Card>
                ...
                <CardContent>
                    <form onSubmit={handleUpdate} className="space-y-6">
                        {/* Similar form as Consultant, maybe Admin has more power, but for now identical */}
