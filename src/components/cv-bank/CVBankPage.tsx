                ...
                {pages.map((p, idx) => (
                    typeof p === 'number' ? (
                        <Button
                            ...
                            size="sm"
                            onClick={() => setPage(p)}
                            className={`h-8 min-w-[32px] ${page === p ? "bg-[#1498e0] hover:bg-[#0d8ad0]" : "text-slate-600"}`}
                        >
                            {p}
                        </Button>
                    ) : (
        ...
        <div className="flex h-[calc(100vh-2rem)] gap-6">
            ...
            <div className="flex-1 flex flex-col h-full overflow-hidden">
                <div className="flex items-center gap-3 mb-4 flex-shrink-0">
                    <div className="w-10 h-10 rounded-lg bg-[#1498e0] text-white flex items-center justify-center shadow-md">
